...
class UserProfile extends Component {
  ...
  render() {
    ...
    if (userProfile) {
      //getting the conn_profile property from the props and Initializing it
      var profilePic;
              ...
              <div className="card-content">
                ...
                >
                  ...
                  <div className="input-field">
                    ...
                    <input
                      type="text"
                      value={this.state.pNo || "Personal Number"}
                      id="pNo"
                      onChange={this.handelChange}
                    />
                  </div>
                  <div className="input-field">
                    ...
                    <input
                      type="text"
                      value={this.state.wNo || "Work Number"}
                      id="wNo"
                      onChange={this.handelChange}
                    />
                  </div>
                ...
                <div style={{ float: "right", backgroundColor: "#D3D3D3" }}>
                  <img
                    ...
                    style={{ display: "block" }}
                  />
                  <img className="card-view" src={this.state.back} alt="" />
                </div>
              </div>
            </div>
          </form>
